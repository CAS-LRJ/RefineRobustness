...
def main():
    ...
    property_index=[1, 9, 15, 17, 19, 21, 23, 24, 25, 35, 36, 38, 47]
    ...
    for net_i in net_list:
        ...
        for property_i in property_list:
            ...
            start=time.time()
            if net.verify_lp_split(PROPERTY=property_i,DELTA=delta,MAX_ITER=50,SPLIT_NUM=0,WORKERS=96,TRIM=True,SOLVER=cp.CBC,MODE=1):
