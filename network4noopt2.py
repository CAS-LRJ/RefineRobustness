...
def main():
    ...
    property_list=['properties/mnist_'+str(i)+'_local_property.in' for i in [0, 2, 3, 4, 5, 6, 7, 10, 11, 13, 14, 16, 18, 20, 22, 26, 27, 28, 29, 30, 31, 32, 33, 34, 37, 39, 40, 41, 42, 43, 44, 45, 46, 48, 49]]
    delta=0.037
    for net_i in net_list:
        pass_list=[]
        nopass_list=[]
